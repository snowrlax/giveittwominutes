  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <h1 className="font-body text-7xl md:text-8xl lg:text-9xl sm:text-center leading-[0.95]">
          <span className="block">
            <span className="hidden md:block absolute top-0 right-[10%] h-8 w-8 md:h-12 md:w-12">
